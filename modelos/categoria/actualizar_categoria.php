...
include_once '../bitacora/Bitacora.php'; // ← Agregamos la clase Bitacora
...
$categoriaEncontrada = $categoria->leerPorId();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result['success']) {
        ...
        $bitacora->accion = "Actualización de categoría";
        $bitacora->descripcion = "Se actualizó la categoría: " . $categoria->nombre;
        $bitacora->registrar();
...
<body>
    ...
    <script>
        ...
        if (message === 'success') {
            Swal.fire({
                title: '¡Éxito!',
                text: 'La categoría ha sido actualizada correctamente en el sistema',
                icon: 'success',
                iconColor: '#1cbb8c',
            ...
            let errorMessage = 'No se pudo completar la actualización. Verifique que la categoría no esté duplicada.';
            Swal.fire({
