                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="es_activo" id="es_activo" value="1" checked>
                            ...
                            <tbody>
                                <?php while ($row = $stmtConversiones->fetch(PDO::FETCH_ASSOC)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge <?php echo $row['es_activo'] ? 'bg-success' : 'bg-secondary'; ?>">
                                                <?php echo $row['es_activo'] ? 'Activo' : 'Inactivo'; ?>
                                            </span>
                                        </td>
